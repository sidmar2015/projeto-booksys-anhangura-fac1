<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cadastrar.aspx.cs" Inherits="BookSys.Cadastrar" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="btnCadastrar" runat="server" Text="CADASTRAR" Width="101px" OnClick="btnCadastrar_Click" />
    </form>
</body>
</html>
